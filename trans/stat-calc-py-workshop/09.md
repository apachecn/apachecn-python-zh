...
在本章中，我们将继续讨论一些中间统计概念。我们将学习大数定律告诉我们当样本变大时样本的平均值。
...
![Figure 9.1: Formula for sample mean ](image/B15968_09_01.jpg)
...
![Figure 9.2: Formula for expected value ](image/B15968_09_02.jpg)
...
7.  Running our notebook will yield the following results:
    ...
    ![Figure 9.3: Average number of heads per coin flip over a sample size ](image/B15968_09_03.jpg)
...
*   赌红色，如果球落在红色上，我们赢：![1](image/B15968_09_InlineEquation1.png)
*   赌红色，如果球落在黑色，我们输了：![2](image/B15968_09_InlineEquation1a.png)
*   赌红色，如果球落在绿色，我们输了：![3](image/B15968_09_InlineEquation2.png)
...
7.  Run your notebook and you will get the following results:
    ...
    ![Figure 9.4: Running average net per game of roulette over 10 games played  ](image/B15968_09_04.jpg)
...
![Figure 9.5: Running average net per game of roulette over 100,000 games played ](image/B15968_09_05.jpg)
...
![Figure 9.6: Formula to calculate the expected value ](image/B15968_09_06.jpg)
...
4.  Create a histogram of the sample means that we collected. Over the top of the histogram, we will overlay what the CLT says the distribution of the sample mean should look like:
    ...
    ![Figure 9.7: Distribution of sample average from 10,000 samples from a uniform distribution with a sample size of 30 ](image/B15968_09_07.jpg)
...
![Figure 9.8: Example of exponential distribution ](image/B15968_09_08.jpg)
...
4.  Running the code that we typed in our Jupyter notebook will give us the following graph:
    ...
    ![Figure 9.9: Distribution of sample average from 10,000 samples from an exponential distribution with a sample size of 5 ](image/B15968_09_09.jpg)
...
![Figure 9.10: Distribution of sample average from 10,000 samples from an exponential distribution with a sample size of 50 ](image/B15968_09_10.jpg)
...
![Figure 9.11: Example of a standard normal model ](image/B15968_09_11.jpg)
...
![Figure 9.12: Distribution of sample average from 10,000 samples from a uniform distribution with a sample size of 30 ](image/B15968_09_12.jpg)

图 9.12：来自均匀分布（样本量为 30）的 10000 个样本的样本平均分布

如果我们看，钟形曲线的中心是 50，这是从 0 到 100 的均匀分布的期望值。从 0 到 100 的均匀分布的预期标准偏差约为 5.27（![4](image/B15968_09_InlineEquation3.png)。因此，应用与之前相同的逻辑，我们的值中约 68%在 45 到 55 之间，约 95%在 40 到 60 之间。这些范围是我们的置信区间。

这里给出了计算 z 置信区间的更正式的方程：

![Figure 9.13: Formula for calculating z-confidence interval ](image/B15968_09_13.jpg)
...
![Figure 9.14: Formula for calculating t-confidence interval ](image/B15968_09_14.jpg)
...
![Figure 9.15: Formula for calculating confidence interval ](image/B15968_09_15.jpg)
...
*   Test statistics: ![5](image/B15968_09_InlineEquation4.png)
...
*   P 值：![6](image/B15968_09_InlineEquation5.png)
...
![Figure 9.16: Formula to calculate test statistics ](image/B15968_09_16.jpg)
...
![Figure 9.17: Formula to calculate t-test ](image/B15968_09_17.jpg)
...
![Figure 9.18: Formula to calculate test statistics for t-test ](image/B15968_09_18.jpg)

图 9.18：计算 t 检验统计数据的公式

注意分母![7](image/B15968_09_InlineEquation6.png)；如果*n*较小，则![8](image/B15968_09_InlineEquation6a.png)的值将较大（对于常数*s*。这会导致测试统计数据分母的值变大，从而导致总体测试统计数据变小。
...
*   上尾（平均值 1 大于平均值 2）：![13](image/B15968_09_InlineEquation7.png)
*   下尾（平均值 1 小于平均值 2）：![14](image/B15968_09_InlineEquation8.png)
*   双尾（平均值 1 与平均值 2 不同）：![15](image/B15968_09_InlineEquation9.png)

对于两样本 t 检验，无效假设将始终设置为 0（![9](image/B15968_09_InlineEquation10.png)。换句话说，无效假设是指两种方法之间没有差异，另一种是指存在差异。2 样本 t 检验的检验统计量如下所示：

![10](image/B15968_09_InlineEquation11.png)具有一定的自由度![16](image/B15968_09_InlineEquation12.png)
...
*   **降低**：如果![a](image/B15968_09_InlineEquation13.png)小于您的显著性水平且您的检验统计为阴性，则拒绝无效假设。
*   **上**：如果![b](image/B15968_09_InlineEquation13a.png)小于您的显著性水平且您的检验统计为阳性，则拒绝无效假设。
...
![Figure 9.19: Formula for linear regression ](image/B15968_09_19.jpg)
...
![Figure 9.20: Formula for linear regression with multiple coefficients ](image/B15968_09_20.jpg)
...
3.  Fit the linear model and graph the data as a scatter plot and our linear regression model:
    ...
    ![Figure 9.21: The linear equation seems to fit our data well ](image/B15968_09_21.jpg)
...
5.  Create a three-dimensional scatter plot and graph the line in the `3d` space to check to see whether it fits our data well:
    ...
    ![Figure 9.22: The linear equation doesn't seem to fit our data well ](image/B15968_09_22.jpg)

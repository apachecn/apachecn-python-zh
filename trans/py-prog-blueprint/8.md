...
![](images/edccbabd-f4f7-4bf9-9e8a-930fe3e07c42.png)
...
![](images/2a95e41c-4f91-4a4e-ab80-64223855e413.png)
...
![](images/2d36948d-637f-4279-8ae5-2ab99d1abc0a.png)

单击右侧的绿色加号。然后，您可以选择要为其创建令牌的用户，准备好后，单击保存。之后，您将看到已创建的令牌列表：

![](images/20e4a65d-5b1a-4455-9ed6-8aad6945c683.png)
...
![](images/b834857f-c578-4561-bf20-7c10a898da7a.png)
...
![](images/23172db2-3235-40a2-8e5d-7fa0e02142bd.png)

完美的它的效果和预期的一样。请注意，将订单发送到订单服务后，购物车也被清空。

现在，点击顶部菜单上的`ORDERS`选项，您会看到我们刚刚提交的订单：

![](images/9a3ff13e-c15e-4cce-8cfa-7d66c14e0787.png)
...
![](images/e36b74d3-ac74-4979-851d-878b9b9f5b7b.png)
...
完美的现在，我们可以复制应用程序，退出此实例，然后从本地计算机运行以下命令：
...
使用`gunicorn`启动应用程序。我们将以`nginx`用户身份启动应用程序：
...
![](images/9660d0a6-ccf9-4d45-981a-f541742d1c64.png)

如果您浏览到使用订单服务的视图，例如“订单”部分，您可以验证一切正常，如果您在网站上下了任何订单，您应该会看到此处列出的订单，如以下屏幕截图所示：

![](images/b57770dd-21a8-4748-81ae-5c8326529984.png)

...
![Designing recursive functions around Python's stack limits](Image00006.jpg)

计算斐波那契数的规则：

![Designing recursive functions around Python's stack limits](Image00007.jpg)
...
***   Write a loop that enumerates all the values:
    ...
    *   Incorporate the reduction function. In this case, we're computing a large product, using multiplication. We can summarize this using ![How to do it...](Image00008.jpg) *x* notation. For this example, we're only imposing a simple boundary on the values computed in the product:

    ![How to do it...](Image00009.jpg)
